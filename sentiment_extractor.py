...
# IMPORTANT: Set your StockGeist API token as an environment variable:
# export STOCKGEIST_API_TOKEN="your_actual_api_token_here"
# Or create a .env file with: STOCKGEIST_API_TOKEN=your_actual_api_token_here
...
def get_data(begin, end):
    for i in range(begin, end+1):
        ...
        headers = {
            ...
            "token": os.getenv("STOCKGEIST_API_TOKEN", "YOUR_API_TOKEN_HERE")
        }
